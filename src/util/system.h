 ...
 */
#ifndef IGNITECOIN_UTIL_SYSTEM_H
#define IGNITECOIN_UTIL_SYSTEM_H
...
extern const char * const IGNITECOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("ignitecoin-%s", name);
...
#endif // IGNITECOIN_UTIL_SYSTEM_H
