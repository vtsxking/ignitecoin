...
#ifndef IGNITECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define IGNITECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // IGNITECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
