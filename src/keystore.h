...
#ifndef IGNITECOIN_KEYSTORE_H
#define IGNITECOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/ignitecoin/bips/blob/master/bip-0013.mediawiki
