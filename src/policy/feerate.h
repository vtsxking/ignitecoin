...
const std::string CURRENCY_UNIT = "IGNC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    IGNC_KVB,      //!< Use IGNC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from IGNC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::IGNC_KVB) const;
