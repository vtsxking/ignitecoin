...
#ifndef IGNITECOIN_SCRIPT_IGNITECOINCONSENSUS_H
#define IGNITECOIN_SCRIPT_IGNITECOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_IGNITECOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/ignitecoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBIGNITECOINCONSENSUS)
...
#define IGNITECOINCONSENSUS_API_VER 1
...
#endif // IGNITECOIN_SCRIPT_IGNITECOINCONSENSUS_H
