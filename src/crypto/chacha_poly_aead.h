// Copyright (c) 2019 The Ignitecoin Core developers
...
/* A AEAD class for ChaCha20-Poly1305@ignitecoin.
 *
 ...
 *
 * The chacha20-poly1305@ignitecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ignitecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ignitecoin are relatively fast in
