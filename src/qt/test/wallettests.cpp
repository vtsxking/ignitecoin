// Copyright (c) 2015-2020 The Ignitecoin Core developers
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_ignitecoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_ignitecoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_ignitecoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = IgnitecoinUnits::formatWithUnit(unit, balance, false, IgnitecoinUnits::SeparatorStyle::ALWAYS);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("ignitecoin:"), 2);
