    ...
    mapper(nullptr)
{
    ...
    ui->ignitecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ignitecoinAtStartup);
    ...
    ui->ignitecoinAtStartup->setToolTip(ui->ignitecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ignitecoinAtStartup->setText(ui->ignitecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openIgnitecoinConfButton->setToolTip(ui->openIgnitecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new IgnitecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ignitecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openIgnitecoinConfButton_clicked()
{
