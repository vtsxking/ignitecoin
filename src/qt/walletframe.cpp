...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, IgnitecoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &IgnitecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &IgnitecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &IgnitecoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &IgnitecoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &IgnitecoinGUI::updateWalletStatus);
    connect(gui, &IgnitecoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
