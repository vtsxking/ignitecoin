...
#ifndef IGNITECOIN_QT_IGNITECOINUNITS_H
#define IGNITECOIN_QT_IGNITECOINUNITS_H
...
/** Ignitecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IgnitecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IgnitecoinUnits(QObject *parent);

    /** Ignitecoin units.
      @note Source: https://en.ignitecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IGNC,
...
typedef IgnitecoinUnits::Unit IgnitecoinUnit;

#endif // IGNITECOIN_QT_IGNITECOINUNITS_H
