    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ignitecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ignitecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &IgnitecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
