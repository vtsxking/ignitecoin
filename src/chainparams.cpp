...
{
    const char* pszTimestamp = "March 16th VTS, Far, Graic";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0xf086349d4e62e82a2961aea06011c8572670e382bd83269f91dee8e67e1ed9ef");
        ...
        /*
        	...
        	143.198.71.203:7187
        */
        vSeeds.emplace_back("143.198.225.238", true);
        vSeeds.emplace_back("104.248.112.168", true);
        vSeeds.emplace_back("143.198.79.67", true);
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x32c3a4a96c2b00ad5274c96731b109bc791e76cb1573ced1d9196bb499f30538"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc6bf0ed3bbb0a453b46f5b40b861d011a62706d231c50003bc78ad650e6ba44"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,130); // 130 = u
        ...
        checkpointData = {
            {
                {0, uint256S("0x32c3a4a96c2b00ad5274c96731b109bc791e76cb1573ced1d9196bb499f30538")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1615955098, 11692, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
