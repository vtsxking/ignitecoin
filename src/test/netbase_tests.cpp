...
{
    BOOST_CHECK(TestSplitHost("www.ignitecoincore.org", "www.ignitecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.ignitecoincore.org]", "www.ignitecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.ignitecoincore.org:80", "www.ignitecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ignitecoincore.org]:80", "www.ignitecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8684", "127.0.0.1", 8684));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8684", "127.0.0.1", 8684));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8684", "::ffff:127.0.0.1", 8684));
    BOOST_CHECK(TestSplitHost("[::]:8684", "::", 8684));
    BOOST_CHECK(TestSplitHost("::8684", "::8684", 0));
    BOOST_CHECK(TestSplitHost(":8684", "", 8684));
    BOOST_CHECK(TestSplitHost("[]:8684", "", 8684));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8684", "127.0.0.1:8684"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8684", "[::]:8684"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
