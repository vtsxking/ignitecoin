...
#ifndef IGNITECOIN_TEST_SCRIPTNUM10_H
#define IGNITECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ignitecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // IGNITECOIN_TEST_BIGNUM_H
