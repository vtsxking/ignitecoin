...
#ifndef IGNITECOIN_WALLET_WALLET_H
#define IGNITECOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! ignitecoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this ignitecoin node, and set to 0 for transactions that were created
...
#endif // IGNITECOIN_WALLET_WALLET_H
