...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Ignitecoin
else
  DOCKER_EXEC echo \> \$HOME/.ignitecoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ignitecoin/ignitecoin/pull/18288#discussion_r433189350 for
  # details.
