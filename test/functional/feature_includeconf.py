#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Ignitecoin Core developers
...
class IncludeConfTest(IgnitecoinTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "ignitecoin.conf"), "a", encoding='utf8') as f:
