...
class P2PPermissionsTests(IgnitecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].ignitecoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].ignitecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
