...
# TestP2PConn: A peer we use to send messages to ignitecoind, and store responses.
...
class CompactBlocksTest(IgnitecoinTestFramework):
    ...
    # This test actually causes ignitecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ignitecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ignitecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ignitecoind will not send blocktxn responses for blocks whose height is
