...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the IgnitecoinTestFramework
    pass


class ExampleTest(IgnitecoinTestFramework):
    # Each functional test is a subclass of the IgnitecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        IgnitecoinTestFramework class so other tests can use it."""
