...
"""Verify that starting ignitecoin with -h works as expected."""

from test_framework.test_framework import IgnitecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(IgnitecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ignitecoin with -h for help text")
        ...
        self.log.info("Start ignitecoin with -version for version information")
        ...
        self.log.info("Start ignitecoind with -fakearg to make sure it does not start")
