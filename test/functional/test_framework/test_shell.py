...
class TestShell:
    """Wrapper Class for IgnitecoinTestFramework.

    The TestShell class extends the IgnitecoinTestFramework
    ...
    class __TestShell(IgnitecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by IgnitecoinTestFramework child class.
            self.num_nodes = 1
