...
void _DbInfoDelete __P((Tcl_Interp *, DIGNCL_INFO *));
int db_Cmd __P((ClientData, Tcl_Interp *, int, Tcl_Obj * CONST*));
int tcl_CompactStat __P((Tcl_Interp *, DIGNCL_INFO *));
...
int tcl_EnvRemove __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *, DIGNCL_INFO *));
...
int tcl_EventNotify  __P((Tcl_Interp *, DB_ENV *, Tcl_Obj *, DIGNCL_INFO *));
...
void tcl_EnvSetErrfile __P((Tcl_Interp *, DB_ENV *, DIGNCL_INFO *, char *));
int tcl_EnvSetErrpfx __P((Tcl_Interp *, DB_ENV *, DIGNCL_INFO *, char *));
DIGNCL_INFO *_NewInfo __P((Tcl_Interp *, void *, char *, enum INFOTYPE));
void *_NameToPtr __P((CONST char *));
DIGNCL_INFO *_PtrToInfo __P((CONST void *));
DIGNCL_INFO *_NameToInfo __P((CONST char *));
void  _SetInfoData __P((DIGNCL_INFO *, void *));
void  _DeleteInfo __P((DIGNCL_INFO *));
...
int tcl_RepTransport  __P((Tcl_Interp *, int, Tcl_Obj * CONST *, DB_ENV *, DIGNCL_INFO *));
...
void _TxnInfoDelete __P((Tcl_Interp *, DIGNCL_INFO *));
int tcl_TxnCheckpoint __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *));
int tcl_Txn __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *, DIGNCL_INFO *));
int tcl_CDSGroup __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *, DIGNCL_INFO *));
int tcl_TxnStat __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *));
int tcl_TxnTimeout __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *));
int tcl_TxnRecover __P((Tcl_Interp *, int, Tcl_Obj * CONST*, DB_ENV *, DIGNCL_INFO *));
