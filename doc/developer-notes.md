...
([`valgrind.supp`](https://github.com/ignitecoin-project/ignitecoin/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7185.
