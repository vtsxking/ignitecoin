...
Ignitecoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Run with the `-testnet` option to run with "play ignitecoins" on the test network, if you
...
- ThreadSocketHandler : Sends/Receives data from peers on port 8684.
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `IGNITECOIN_FOO_BAR_H`, e.g.

```c++
#ifndef IGNITECOIN_FOO_BAR_H
#define IGNITECOIN_FOO_BAR_H
...
#endif // IGNITECOIN_FOO_BAR_H
```
...
Commit [`bb81e173`](https://github.com/ignitecoin/ignitecoin/commit/bb81e173) is an example of a scripted-diff.
