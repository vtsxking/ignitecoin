Ignitecoin Core version *0.15.1* is now available from:
  ...
  <https://download.ignitecoin.org/ignitecoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 embers per kB (0.00001 IGNC). This is to prepare for dropping the minimum transaction fee to 0.1 embers per kB (0.0001 IGNC) in the next release.
