Ignitecoin Core version 0.9.4 is now available from:

  https://ignitecoin.org/bin/0.9.4/
...
this update is incompatible with the Ignitecoin system and could lead to consensus
forks.

Ignitecoin Core released binaries from https://ignitecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ignitecoin/+archive/ubuntu/ignitecoin
- A third-party or self-compiled Ignitecoin Core

upgrade to Ignitecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
