Ignitecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ignitecoin/files/Ignitecoin/ignitecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ignitecoin
...
New/changed settings (command-line or ignitecoin.conf file)
--------------------------------------------------------
