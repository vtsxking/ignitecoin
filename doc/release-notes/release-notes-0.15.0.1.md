Ignitecoin Core version *0.15.0.1* is now available from:

  <https://ignitecoin.org/bin/ignitecoin-core-0.15.0.1/>

and

  <https://ignitecoincore.org/bin/ignitecoin-core-0.15.0.1/>
