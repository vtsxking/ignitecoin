Ignitecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ignitecoin/files/Ignitecoin/ignitecoin-0.5.4/
...
http://gitorious.org/ignitecoin/ignitecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ignitecoin-Qt notifications under Growl 1.3.
Increase required age of Ignitecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIgnitecoin properly when installing Ignitecoin-Qt over it. (Windows)
