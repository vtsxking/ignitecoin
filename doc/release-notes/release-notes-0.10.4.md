Ignitecoin Core version 0.10.4 is now available from:

  <https://ignitecoin.org/bin/ignitecoin-core-0.10.4/>
...
- #6953 `43c2789` Split ignitecoin-tx into its own package
- #6953 `dfe0d4d` Include ignitecoin-tx binary on Debian/Ubuntu
