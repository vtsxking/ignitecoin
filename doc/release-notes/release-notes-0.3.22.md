Download URL: https://sourceforge.net/projects/ignitecoin/files/Ignitecoin/ignitecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 IGNC fee schedule (users still pay 0.01 IGNC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ignitecoin00 - #ignitecoin99
