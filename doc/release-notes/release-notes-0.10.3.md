Ignitecoin Core version 0.10.3 is now available from:

  <https://ignitecoin.org/bin/ignitecoin-core-0.10.3/>
...
(see https://github.com/ignitecoin/ignitecoin/pull/6793, as well as the 0.11.0
