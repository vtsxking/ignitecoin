Ignitecoin Core version 0.9.2.1 is now available from:

  https://ignitecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 IGNC to 0.01 IGNC
...
- Fix "Start ignitecoin on system login"
