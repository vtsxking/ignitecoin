Ignitecoin Core version *0.15.2* is now available from:

  <https://ignitecoincore.org/bin/ignitecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in ignitecoin-tx (TheBlueMatt)
