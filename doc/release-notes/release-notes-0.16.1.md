Ignitecoin Core version 0.16.1 is now available from:

  <https://ignitecoincore.org/bin/ignitecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting ignitecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure ignitecoind processes are cleaned up when tests end (sdaftuar)
