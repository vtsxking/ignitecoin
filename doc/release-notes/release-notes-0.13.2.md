Ignitecoin Core version 0.13.2 is now available from:
  ...
  <https://ignitecoin.org/bin/ignitecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ignitecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ignitecoin-tx to create v2 transactions (igncdrak)
