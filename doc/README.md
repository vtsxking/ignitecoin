...
- [Source Code Documentation (External Link)](https://dev.visucore.com/ignitecoin/doxygen/)
...
* Discuss project-specific development on #ignitecoin-core-dev on Freenode. If you don't have an IRC client, use [webchat here](http://webchat.freenode.net/?channels=ignitecoin-core-dev).
