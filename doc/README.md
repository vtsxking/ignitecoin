...
To download Ignitecoin Core, visit [ignitecoin.org](https://ignitecoin.org/).
...
* See the documentation at the [Ignitecoin Wiki](https://ignitecoin.info/)
for help and more information.
* Ask for help on [#ignitecoin](http://webchat.freenode.net?channels=ignitecoin) on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net?channels=ignitecoin).
* Ask for help on the [IgnitecoinTalk](https://ignitecointalk.io/) forums, in the [Technical Support section](https://ignitecointalk.io/c/technical-support).
...
### Resources
* Discuss on the [IgnitecoinTalk](https://ignitecointalk.io/) forums.
* Discuss general Ignitecoin development on #ignitecoin-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=ignitecoin-dev.
