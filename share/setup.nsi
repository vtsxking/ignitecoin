...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Ignitecoin Core (testnet, -bit).lnk" "$INSTDIR\ignitecoin-qt" "-testnet" "$INSTDIR\ignitecoin-qt" 1
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Ignitecoin Core (testnet, -bit).lnk"
