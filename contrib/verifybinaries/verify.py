...
def main(args):
    ...
    if not success:
        print("ignitecoin.org failed to provide signature file, "
              "but ignitecoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("ignitecoin.org and ignitecoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Ignitecoin Core binary release "
