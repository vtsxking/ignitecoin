...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ignitecoin repository."
  exit 1
fi
...
# See https://github.com/ignitecoin/ignitecoin/issues/16064
...
echo 'When compiling ignitecoind, run `./configure` in the following way:'
echo
